...
rg_name  =  "{}{}{:02d}{:02d}{:02d}{:02d}".format('shivdeepwinrm-',
    time_now.year, time_now.month, time_now.day, time_now.hour, time_now.minute)

powershell_cmd = "New-AzResourceGroup -Name {resourceGroupName} -location eastus".format(resourceGroupName=rg_name)
...
for line in file.readlines():
    ...
    if array[1].startswith('sqldev') or array[1].startswith('enterprise'):
...
# After running python script, run below command on Azure cloud shell
